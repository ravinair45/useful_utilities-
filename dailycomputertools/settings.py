"""
Django settings for dailycomputertools project.
...
SECRET_KEY = 'django-insecure-yd3p^v+(*3mqkv)1#&d=4c(p)1u_b)k2(s(ca&*51_#qg&q5_p'
...
ROOT_URLCONF = 'dailycomputertools.urls'
...
WSGI_APPLICATION = 'dailycomputertools.wsgi.application'
